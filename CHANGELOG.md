...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.23.0...d63c33afb9872f2781997b2428d7e9e0c1d23d41))
...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.21.1...1a486e06155a4d8e58e716fd40468cb5738ed6bb))
...
- Update CI [#1073](https://github.com/ipython/alpaca_kernel/pull/1073) ([@blink1073](https://github.com/blink1073))
...
[@blink1073](https://github.com/search?q=repo%3Aipython%2Falpaca_kernel+involves%3Ablink1073+updated%3A2022-12-08..2022-12-08&type=Issues) | [@ccordoba12](https://github.com/search?q=repo%3Aipython%2Falpaca_kernel+involves%3Accordoba12+updated%3A2022-12-08..2022-12-08&type=Issues)
...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.15.2...861b1242a7601f1608707ed8bbfb6e801914cb4a))
...
- Back to top-level tornado IOLoop [#958](https://github.com/ipython/alpaca_kernel/pull/958) ([@minrk](https://github.com/minrk))
...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.13.0...82179ef8ae4e9bdcd99a4a4c3807e8f773f1e92c))
...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.12.1...05c6e655e497a944fd738d9b744fad90bc78b70a))
...
[@blink1073](https://github.com/search?q=repo%3Aipython%2Falpaca_kernel+involves%3Ablink1073+updated%3A2022-04-04..2022-04-04&type=Issues)
...
([Full Changelog](https://github.com/ipython/alpaca_kernel/compare/v6.9.1...d6744f9e423dacc6b317b1d31805304e89cbec5d))
...
- Fixup master build [#649](https://github.com/ipython/alpaca_kernel/pull/649) ([@SylvainCorlay](https://github.com/SylvainCorlay))
...
- Kernelspec: ensure path is writable before writing `kernel.json`. [#593](https://github.com/ipython/alpaca_kernel/pull/593) ([@jellelicht](https://github.com/jellelicht))
...
- Add github actions, bail on asyncio patch for tornado 6.1.
  [#564](https://github.com/ipython/alpaca_kernel/pull/564)
- Start testing on Python 3.9. [#551](https://github.com/ipython/alpaca_kernel/pull/551)
- Fix stack levels for alpaca_kernel's deprecation warnings and stop
  using some deprecated APIs. [#547](https://github.com/ipython/alpaca_kernel/pull/547)
- Add env parameter to kernel installation [#541](https://github.com/ipython/alpaca_kernel/pull/541)
- Fix stop_on_error_timeout blocking other messages in queue.
  [#539](https://github.com/ipython/alpaca_kernel/pull/539)
- Remove most of the python 2 compat code. [#537](https://github.com/ipython/alpaca_kernel/pull/537)
- Remove u-prefix from strings. [#538](https://github.com/ipython/alpaca_kernel/pull/538)

## 5.3

### 5.3.4

- Only run Qt eventloop in the shell stream. [#531](https://github.com/ipython/alpaca_kernel/pull/531)

### 5.3.3

- Fix QSocketNotifier in the Qt event loop not being disabled for the
  control channel. [#525](https://github.com/ipython/alpaca_kernel/pull/525)

### 5.3.2

- Restore timer based event loop as a Windows-compatible fallback.
  [#523](https://github.com/ipython/alpaca_kernel/pull/523)

### 5.3.1

- Fix #520: run post_execute and post_run_cell on async cells
  [#521](https://github.com/ipython/alpaca_kernel/pull/521)
- Fix exception causes in zmqshell.py [#516](https://github.com/ipython/alpaca_kernel/pull/516)
- Make pdb on Windows interruptible [#490](https://github.com/ipython/alpaca_kernel/pull/490)

### 5.3.0

5.3.0 Adds support for Trio event loops and has some bug fixes.

- Fix ipython display imports [#509](https://github.com/ipython/alpaca_kernel/pull/509)
- Skip test_unc_paths if OS is not Windows [#507](https://github.com/ipython/alpaca_kernel/pull/507)
- Allow interrupting input() on Windows, as part of effort to make pdb
  interruptible [#498](https://github.com/ipython/alpaca_kernel/pull/498)
- Add Trio Loop [#479](https://github.com/ipython/alpaca_kernel/pull/479)
- Flush from process even without newline [#478](https://github.com/ipython/alpaca_kernel/pull/478)
...
- Handle system commands that use UNC paths on Windows
  [#500](https://github.com/ipython/alpaca_kernel/pull/500)
- Add offset argument to seek in io test [#496](https://github.com/ipython/alpaca_kernel/pull/496)
...
- Produce better traceback when kernel is interrupted
  [#491](https://github.com/ipython/alpaca_kernel/pull/491)
- Add `InProcessKernelClient.control_channel` for compatibility with
  jupyter-client v6.0.0 [#489](https://github.com/ipython/alpaca_kernel/pull/489)
- Drop support for Python 3.4 [#483](https://github.com/ipython/alpaca_kernel/pull/483)
- Work around issue related to Tornado with python3.8 on Windows
  ([#480](https://github.com/ipython/alpaca_kernel/pull/480), [#481](https://github.com/ipython/alpaca_kernel/pull/481))
- Prevent entering event loop if it is None [#464](https://github.com/ipython/alpaca_kernel/pull/464)
- Use `shell.input_transformer_manager` when available
  [#411](https://github.com/ipython/alpaca_kernel/pull/411)
...
- Fix pickle issues when using inline matplotlib backend
  [#476](https://github.com/ipython/alpaca_kernel/pull/476)
- Fix an error during kernel shutdown [#463](https://github.com/ipython/alpaca_kernel/pull/463)
- Fix compatibility issues with Python 3.8 ([#456](https://github.com/ipython/alpaca_kernel/pull/456), [#461](https://github.com/ipython/alpaca_kernel/pull/461))
- Remove some dead code ([#474](https://github.com/ipython/alpaca_kernel/pull/474),
  [#467](https://github.com/ipython/alpaca_kernel/pull/467))
...
- Fix comm shutdown behavior by adding a `deleting` option to `close`
  ...
  shutdown ([#433](https://github.com/ipython/alpaca_kernel/pull/433), [#435](https://github.com/ipython/alpaca_kernel/pull/435))
- Fix `Heartbeat._bind_socket` to return on the first bind ([#431](https://github.com/ipython/alpaca_kernel/pull/431))
- Moved `InProcessKernelClient.flush` to `DummySocket` ([#437](https://github.com/ipython/alpaca_kernel/pull/437))
- Don't redirect stdout if nose machinery is not present ([#427](https://github.com/ipython/alpaca_kernel/pull/427))
- Rename `_asyncio.py` to
  `_asyncio_utils.py` to avoid name conflicts on Python
  3.6+ ([#426](https://github.com/ipython/alpaca_kernel/pull/426))
- Only generate kernelspec when installing or building wheel ([#425](https://github.com/ipython/alpaca_kernel/pull/425))
- Fix priority ordering of control-channel messages in some cases
  [#443](https://github.com/ipython/alpaca_kernel/pull/443)
...
- Fix socket-binding race conditions ([#412](https://github.com/ipython/alpaca_kernel/pull/412),
  [#419](https://github.com/ipython/alpaca_kernel/pull/419))
- Add a no-op `flush` method to `DummySocket` and comply with stream
  API ([#405](https://github.com/ipython/alpaca_kernel/pull/405))
- Update kernel version to indicate kernel v5.3 support ([#394](https://github.com/ipython/alpaca_kernel/pull/394))
- Add testing for upcoming Python 3.8 and PEP 570 positional
  parameters ([#396](https://github.com/ipython/alpaca_kernel/pull/396), [#408](https://github.com/ipython/alpaca_kernel/pull/408))

### 5.1.1

5.1.1 fixes a bug that caused cells to get stuck in a busy state.

- Flush after sending replies [#390](https://github.com/ipython/alpaca_kernel/pull/390)

### 5.1.0

5.1.0 fixes some important regressions in 5.0, especially on Windows.

[5.1.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/5.1)

- Fix message-ordering bug that could result in out-of-order
  executions, especially on Windows [#356](https://github.com/ipython/alpaca_kernel/pull/356)
- Fix classifiers to indicate dropped Python 2 support
  [#354](https://github.com/ipython/alpaca_kernel/pull/354)
- Remove some dead code [#355](https://github.com/ipython/alpaca_kernel/pull/355)
- Support rich-media responses in `inspect_requests` (tooltips)
  [#361](https://github.com/ipython/alpaca_kernel/pull/361)

## 5.0

### 5.0.0

[5.0.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/5.0)

- Drop support for Python 2. `alpaca_kernel` 5.0 requires Python >= 3.4
- Add support for IPython's asynchronous code execution
  [#323](https://github.com/ipython/alpaca_kernel/pull/323)
- Update release process in `CONTRIBUTING.md` [#339](https://github.com/ipython/alpaca_kernel/pull/339)

## 4.10

[4.10 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.10)

- Fix compatibility with IPython 7.0 [#348](https://github.com/ipython/alpaca_kernel/pull/348)
- Fix compatibility in cases where sys.stdout can be None
  [#344](https://github.com/ipython/alpaca_kernel/pull/344)

## 4.9

### 4.9.0

[4.9.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.9)

- Python 3.3 is no longer supported [#336](https://github.com/ipython/alpaca_kernel/pull/336)
- Flush stdout/stderr in KernelApp before replacing
  [#314](https://github.com/ipython/alpaca_kernel/pull/314)
- Allow preserving stdout and stderr in KernelApp
  [#315](https://github.com/ipython/alpaca_kernel/pull/315)
- Override writable method on OutStream [#316](https://github.com/ipython/alpaca_kernel/pull/316)
- Add metadata to help display matplotlib figures legibly
  [#336](https://github.com/ipython/alpaca_kernel/pull/336)

## 4.8

### 4.8.2

[4.8.2 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.8.2)

- Fix compatibility issue with qt eventloop and pyzmq 17
  [#307](https://github.com/ipython/alpaca_kernel/pull/307).

### 4.8.1

[4.8.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.8.1)

- set zmq.ROUTER_HANDOVER socket option when available to workaround
  libzmq reconnect bug [#300](https://github.com/ipython/alpaca_kernel/pull/300).
- Fix sdists including absolute paths for kernelspec files, which
  prevented installation from sdist on Windows
  [#306](https://github.com/ipython/alpaca_kernel/pull/306).

### 4.8.0

[4.8.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.8)

- Cleanly shutdown integrated event loops when shutting down the
  kernel. [#290](https://github.com/ipython/alpaca_kernel/pull/290)
- `%gui qt` now uses Qt 5 by default rather than Qt 4, following a
  similar change in terminal IPython. [#293](https://github.com/ipython/alpaca_kernel/pull/293)
- Fix event loop integration for `asyncio` when run with Tornado 5, which uses asyncio where
  available. [#296](https://github.com/ipython/alpaca_kernel/pull/296)

## 4.7

### 4.7.0

[4.7.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.7)
...
[4.6.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.6.1)

- Fix eventloop-integration bug preventing Qt windows/widgets from
  displaying with alpaca_kernel 4.6.0 and IPython ≥ 5.2.
- Avoid deprecation warnings about naive datetimes when working with
  jupyter_client ≥ 5.0.

### 4.6.0

[4.6.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.6)
...
- Add `alpaca_kernel_launcher` module which removes the
...
[4.5.2 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.5.2)
...
[4.5.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.5.1)
...
[4.5 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.5)
...
[4.4.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.4.1)
...
[4.4.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.4)
...
[4.3.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.3)
...
- Deprecate some vestiges of the Big Split:
  ...
  - `alpaca_kernel.find_connection_file`
    is deprecated. Use
    `jupyter_client.find_connection_file` instead.

  \- Various pieces of code specific to IPython parallel are
  deprecated in alpaca_kernel and moved to ipyparallel.

## 4.2

### 4.2.2

[4.2.2 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.2.2)
...
[4.2.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.2.1)

- Fix default display name back to "Python X" instead of "pythonX"

### 4.2.0

[4.2 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.2)
...
[4.1.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.1.1)

- Fix missing `alpaca_kernel.__version__` on Python 2.
- Fix missing `target_name` when opening comms from the frontend.

### 4.1.0

[4.1 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.1)
...
[4.0 on GitHub](https://github.com/ipython/alpaca_kernel/milestones/4.0)

4.0 is the first release of alpaca_kernel as a standalone package.
